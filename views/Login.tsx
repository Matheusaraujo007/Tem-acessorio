      ...
      <div className="w-full max-w-md px-6 z-10 animate-in fade-in zoom-in-95 duration-500">
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl p-10 rounded-[3rem] shadow-2xl border border-white/20 dark:border-slate-800">
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">{systemConfig.companyName}</h1>
            <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Acesso ao Terminal de Gestão</p>
          </div>
          ...
          <div className="mt-10 pt-8 border-t border-slate-100 dark:border-slate-800 flex flex-col items-center gap-4">
             <button className="text-[10px] font-black text-slate-400 hover:text-primary transition-colors uppercase">Esqueceu sua senha?</button>
             <p className="text-[9px] text-slate-300 font-bold uppercase tracking-[0.2em]">Retail Cloud v4.5.0</p>
          </div>
        </div>
      </div>
    </div>
